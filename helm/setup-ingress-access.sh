...
echo "   - Weaviate:             http://weaviate.local:8080"
...
echo "echo '127.0.0.1 test.local rabbitmq.local clickhouse.local weaviate.local influxdb.local registry.local ray.local' | sudo tee -a /etc/hosts"
echo ""
